...
// 34326 here starting and end number 3 and 6 will be extreme digits and middle digits will be mean digits
// if sum of mean digits equals to sum of extrm digits its xylem number else it is phloem number	
