...
//
//	Else, perform fill.
//	In the fill function, firstly we check if the row and column are valid or not, also we check if the color of that pixel is same as origColor or not as if it is not we need not change that pixel, if any of these condition is true, we backrack.
//
