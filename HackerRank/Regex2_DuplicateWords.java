 ...
 * 
 * Groups input = input.replaceAll(m.group(), m.group(1)) The line of code above
 ...
 * Hope this helps.
 * 
 * 10/20/18 - Looks like the problem statement changed a bit, and digits should
 * no longer be in the regular expression. User @4godspeed has an updated
