...
//		Output: true
//		Explanation:
//		12 + 92 = 82 [ 19:  1*1 + 9*9 =82 ] Add sqare of both digits.
//		82 + 22 = 68 [ 82:  8*8 + 2*2 = 68 ] 
//		62 + 82 = 100 [ 68 : 6*6 + 8*8 = 100 ]
//		12 + 02 + 02 = 1 [ 100: 1*1 +0*0 + 0*0 = 1, hence happy number ] 
...
//		public int squareOfAllNumbers (int number) {
//	  
//		while (number != 0) {
//			
//		lastDigit =  number % 10;
